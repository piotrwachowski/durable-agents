"""Example 02 — Submit a task to the planner agent.

Requires the workers (worker.py) and Temporal server to be running.
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print('Usage: uv run python examples/02_planner_subagents/client.py "<task>"')
        sys.exit(1)
